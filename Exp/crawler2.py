    ...
    if start:
      try:
        ...
        for version in version_list:
            if version[0] != '0':
                # Skip non-experimental versions
                continue
        ...
        sql = "UPDATE AllLibs SET dev_version_num = %s, dev_jsfile_num = %s, dev_jsfiles = %s WHERE name = %s;"
        val = (version_num, file_num, json_str, lib_name)
        ...
        with open('data/error_lib.log', "a") as outfile:
